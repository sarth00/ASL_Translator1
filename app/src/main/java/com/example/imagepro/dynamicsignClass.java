...
public class  dynamicsignClass {
    ...
    dynamicsignClass(AssetManager assetManager,String modelPath, String labelPath,int inputSize,String classification_model,int classification_iput_size) throws IOException{
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                //checking output
                Log.d("objectDetectionClass","output class value"+output_class_value[0][0]);
